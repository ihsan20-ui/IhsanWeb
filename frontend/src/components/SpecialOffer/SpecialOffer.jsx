...
import FloatingPartical from '../FloatingPartical/FloatingPartical';
    ...
    <div className=' bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-4 font-[Poppins]'>
        <div className=' max-w-7xl mx-auto'>
            <div className=' text-center mb-14'>
                <h1 className=' text-5xl font-bold mb-4 transform transition-all bg-gradient-to-r from-amber-400
                 ...
                 <p className=' text-lg text-gray-300 max-w-3xl mx-auto tracking-wide leading-relaxed'>
                    Savor the extraodinary with our culinary masterpieces crafted to perfection .
                 </p>
            </div>
            {/* product */}
            <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8'>
                    ...
                    {qty>0 ?(
                        <div className=' flex items-center gap-3'>
                            <button onClick={() =>{qty > 1 ? updateQuantity(cartId,qty -1)
                             ...
                             justify-center hover:bg-amber-800/50 transition-all delay-200 active:scale-95'>
                        ...
                        className={`${addButtonBase} ${addButtonHover} ${commonTransition}`}>
                            <div className=' absolute inset-0 bg-gradient-to-r from-amber-500/20 to-transparent
                             opacity-0 hover:opacity-100 transition-opacity delay-300'/>
             ...
             <div className=' absolute inset-0 rounded-3xl pointer-none border-2 border-transparent group-hover:border-amber-500/30
            ...
            <div className=' mt-12 flex justify-center'>
             ...
             text-white px-8 py-4 rounded-2xl font-bold text-lg uppercase tracking-wide hover:gap-4 hover:scale-105
              hover:shadow-amber-500/20 transition-all duration-300 group border-2 border-amber-400/30 relative
               overflow-hidden'>
