...
import { href, Navigate, NavLink, useLocation, useNavigate } from 'react-router-dom';
import { FiBook, FiHome, FiKey, FiLogIn, FiLogOut, FiPackage, FiPhone, FiShoppingCart, FiStar } from 'react-icons/fi';
    ...
    const renderDesktopAuthButton =() =>{
        return isAuthenticated ?(
            ...
            <button onClick={() => navigate('/login')} className='px-3 lg:px-4 py-1.5 lg:py-2 bg-gradient-to-br from-amber-500
             ...
             transform hover:scale-[1.02] border-2
             border-amber-600/20 flex items-center space-x-2 shadow-md shadow-amber-900/20 text-sm'>
