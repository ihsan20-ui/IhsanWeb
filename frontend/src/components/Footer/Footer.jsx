...
const Footer = () => {
    ...
    const handleSubmit =(e) =>{
       e.preventDefault();
       alert(`thanks for subscribing ! We well send updates to ${email}`);
       setEmail('');
    }
  return (
        ...
        <div className=' max-w-7xl mx-auto relative z-10'>
            <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12'>
                <div className=' space-y-6'>
                    ...
                    When culinary artistry meet doorstep convenience. <br />
                    ...
                    <form onSubmit={handleSubmit} className=' relative mt-8 group '>
                        ...
                        <div className=' relative '>
                            ...
                            className='  w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2 border-amber-400/30 focus:outline-none
                             ...
                             via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30
                              overflow-hidden transition-all duration-500'>
                                <span className=' font-bold text-sm tracking-wide transition-transform duration-300 group-hover:-translate-x-1'>Join Us</span>
                                <BiChevronRight className=' text-xl transition-transform delay-300 group-hover:animate-spin
                                 flex-shrink-0'/>
                ...
                <div className=' flex justify-center md:justify-end'>
                    <div className=' space-y-4'>
                      ...
                      <div className=' flex space-x-4 '>{socialIcons.map(({icon : Icon, link, color , label} ,idx) => (
                        <a href={link} key={idx} target='_blank' className=' text-2xl bg-amber-400/10 p-3 rounded-full hover:bg-amber-400/20
                         hover:scale-110 transition-all duration-300 relative group ' style={{color}}>
                            <Icon className=' scale-125 transition-transform'/>
                            <span className=' absolute -bottom-8 left-1/2 -translate-x-1/2 bg-amber-400
                             text-black px2 py1 rounded text-xs font-bold opacity-0
            ...
            <div className=' border-t border-amber-800 pt-8 mt-8 text-center'>
                ...
                <div className=' gorup inline-block'>
