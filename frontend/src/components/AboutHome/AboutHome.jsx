            ...
            <div className=' w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
                <div className=' space-y-4 sm:space-y-8 px-4 sm:px-0'>
                    ...
                    <p className=' text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif
                     italic border-l-4 bg-amber-500/60 pl4 sm:pl-6 py-2 bg-gradient-to-r from-white/5 to-transparent'>
                ...
                <div className=' grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 px-4 sm:px-0'>
                    {aboutfeature.map((item,i) =>(
                        <div key={i} className=' flex flex-col items-center justify-center gap-3 sm:gap-4 transition-transform
                         delay-300 p-4 sm:p-5 hover:translate-x-2'>
                            <div className={`p-3 sm:p-4 rounded-full bg-gradient-to-br ${item.color}
                             transition-transform delay-300 group-hover:scale-110`}>
                ...
                <div className=' flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0'>
                    <Link to='/about' className=' px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-amber-500 to-orange-600
                     rounded-xl font-bold hover: scale-[1.02] transition-transform duration-300 flex items-center gap-2 sm:gap-3
                      shadow-xl hover:shadow-lime-500/20 group relative overflow-hidden'>
                        <span className=' absolute inset-0 bg-gradient-to-r fill-amber-600/30 to-transparent
                         opacity-0 group-hover:opacity-100 transition-opacity delay-300'></span>
                         <FaInfoCircle className=' text-lg sm:text-xl animate-pulse'/>
                         <span className=' font-cursive text-lg sm:text-xl'> Unveil Our Legancy</span>
                      </Link>
                </div>
            </div>
                ...
                <div className=' relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-600/40 transition
                 duration-500 shadow-2xl shadow-black/50'>
                    ...
                    <img src={AboutImage} alt="Restaurant" className=' w-full h-auto object-cover aspect-[3/4] transform
                     -rotate-1 hover:rotate-0 transition-all delay-500'/>
