...
import { FiGlobe, FiMapPin, FiPhone ,FiMail, FiMessageSquare, FiArrowDownRight } from 'react-icons/fi'
import { contactFormFields } from '../../assets/dummydata'
export const Contact = () => {
    const whatsappNumber = "0096170023851";
  ...
  return (
    <div className=' min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 animate-gradient-x py-12
     sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 font[Poppins] relative overflow-hidden'>
        ...
        <div className=' absolute bottom-40 right-20 w-16 h-16 bg-green-500/20 rounded-full animate-float'/>
         ...
         <div className=' max-w-7xl mx-auto relative z-10'>
            ...
            <div className=' grid grid-cols-1 md:grid-cols-2 gap-8'>
                <div className=' space-y-6'>
                    <div className=' relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform
                     transition-transform duration-300 hover:scale-[1.02] animate-card-float border-l-4
                      border-amber-500 hover:border-amber-400 group'>
                        <div className=' absolute inset-0 bg-gradient-to-r from-amber-500/10 to-transparent opacity-0
                         ...
                         <div className=' relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform
                     transition-transform duration-300 hover:scale-[1.02] animate-card-float border-l-4
                      border-green-500 hover:border-green-400 group'>
                        <div className=' absolute inset-0 bg-gradient-to-r from-green-500/10 to-transparent opacity-0
                         ...
                         <div className=' relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform
                     transition-transform duration-300 hover:scale-[1.02] animate-card-float border-l-4
                      border-orange-500 hover:border-orange-400 group'>
                        <div className=' absolute inset-0 bg-gradient-to-r from-orange-500/10 to-transparent opacity-0
                         ...
                         <div className=' flex items-center mb-4 relative z-10'>
                            ...
                            <h3 className=' ml-4 text-orange-100 text-xl font-semibold'>Email Adderss</h3>
                         </div>
                         <div className=' pl-12 relative z-10'>
                            <p className=' text-amber-100 font-light text-lg'>
                                ihsan2005@gmail.com
                ...
                {/*  */}
                     <div className=' relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl animate-slid-in-right  border-2
                         ...
                         <form onSubmit={handleSubmit} className=' space-y-6 relative z-10'>
                            ...
                            <div key={name}>
                                ...
                                <div className=' relative'>
                                    ...
                                    className=' w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30
                                     rounded-xl  text-amber-50 focus:ring-2 focus:ring-amber-500 focus:border-transparent
                            ...
                            <div>
                                ...
                                <div className=' relative'>
                                    ...
                                    className=' w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30
                                     rounded-xl  text-amber-50 focus:ring-2 focus:ring-amber-500 focus:border-transparent
                                      placeholder-amber-200/50' placeholder='type your message here...' required></textarea>
                                </div>
                            </div>
                            <button type='submit' className=' w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700
                             hover:to-orange-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02]
