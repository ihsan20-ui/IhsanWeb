...
const OurHomeMenu = () => {
  ...
  // 🛠 Safe cart search without crashing
  const getCartEntry = id =>
    cartItems.find(ci => ci.item && ci.item._id === id)
                    ...
                    <div className='flex items-center gap-2'>
                      {qty > 0 && cartEntry ? (
                        ...
                        <button
                          ...
                          className='bg-amber-900/40 px-4 py-1.5 rounded-full font-cinzel text-xs uppercase sm:text-sm tracking-wider transition-transform duration-300 hover:scale-110 border border-amber-800/50'
                        >
