    ...
    <div className="relative">
      <div className="bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 text-white
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
          ...
          <div className="flex-1 space-y-8 relative md:pr-8 lg:pr-10 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6">
              ...
              <button
                ...
                className="group flex items-center gap-3 bg-gradient-to-r from-amber-400 to-amber-300 hover:from-amber-300 hover:to-amber-200 px-6
                  py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-amber-300/30"
              >
          ...
          {/* RIGHT CONTENT (Main + Orbiting Images) */}
            ...
            <div className="relative rounded-full p-1 bg-gradient-to-br from-amber-700 via-amber-800 to-amber-400
              ...
              <img
                ...
                className="rounded-full border-4 xs:border-8 border-amber-900/50
                  w-full h-full object-cover object-top z-20"
              />
              <div className="absolute inset-0 rounded-full bg-gradient-to-b from-transparent to-amber-900/40 mix-blend-multiply z-10b "></div>
              ...
              {orbitImages.map((imgSrc, index) => (
                <div
                  ...
                  className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 
                    orbit ${index > 0 ? `orbit-delay-${index * 5}` : ""} 
                    w-[80px] xs:w-[100px] sm:w-[150px] h-[80px] xs:h-[100px] sm:h-[150px] z-0`}
                >
                  <img
                    src={imgSrc}
      ...
      {showVideo && (
        <div className=' fixed inset-0 flex items-center justify-center z-50 bg-black/90 backdrop-blur-lg p-4'>
            <button onClick={()=>setShowVideo(false)}
                className=' absolute top-6 text-amber-400 hover:text-amber-300 text-3xl z-10 transition-all'>
                    <FaTimes/>
            </button>
